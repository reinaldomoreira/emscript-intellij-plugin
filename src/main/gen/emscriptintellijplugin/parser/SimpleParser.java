...
import emscriptintellijplugin.psi.SimpleTypes;
...
public class SimpleParser implements PsiParser, LightPsiParser {
  ...
  static boolean item_(PsiBuilder b, int l) {
    ...
    if (!r) r = GeneratedParserUtilBase.consumeToken(b, SimpleTypes.CRLF);
  ...
  private static boolean property_0(PsiBuilder b, int l) {
    ...
    r = r && GeneratedParserUtilBase.consumeToken(b, SimpleTypes.SEPARATOR);
  ...
  private static boolean property_0_0(PsiBuilder b, int l) {
    ...
    GeneratedParserUtilBase.consumeToken(b, SimpleTypes.KEY);
    return true;
  }
